...
<body class="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover" style="background-image:url('/images/fondo.jpg');">
	...
	<div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
		...
		<div class="p-4 md:p-12 text-center lg:text-left">
			...
			<div class="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
				...
				<a class="link" href="#" data-tippy-content="@twitch_handle"><svg  class="h-6 fill-current text-gray-600 hover:text-green-700" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Twitch</title><path d="M11.571 4.714h1.715v5.143H11.57zm4.715 0H18v5.143h-1.714zM6 0L1.714 4.286v15.428h5.143V24l4.286-4.286h3.428L22.286 12V0zm14.571 11.143l-3.428 3.428h-3.429l-3 3v-3H6.857V1.714h13.714Z"/></svg></a>
                <a href="{{route('login')}}" class="link" data-tippy-content="Iniciar Sesión"><i class="fas fa-sign-in-alt h-6 fill-current text-gray-600 hover:text-green-700 "></i></a>
                <a href="{{route('register')}}" class="link" data-tippy-content="Registrate"><i class="fas fa-user-plus h-6 fill-current text-gray-600 hover:text-green-700"></i></a>
